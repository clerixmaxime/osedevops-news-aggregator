...
<html>
  ...
  <body>
      ...
      <div class="row">
       ...
       <div class="col-md-8">
          <div class="panel panel-default">
            ...
            <div class="panel-body" id="article_fr">
            </div>
          </div>
        </div>
       ...
       <div class="col-md-8">
          <div class="panel panel-default">
            ...
            <div class="panel-body" id="article_en">
            </div>
          </div>
        </div>
    ...
    function retrieveArticleEN() {
      $.get(ARTICLES_URL+"/article_en.php", function( data ) {
          console.log('In handler !');
          if (data != null) {
            $('#article_en').html(data);
            $('#article_en img').each(function(){ this.src = ARTICLES_URL + '/' + this.src.substr(this.src.indexOf('images/')) });
          }
      })
      .fail(function(data) {
        console.log('In fail ! - ' + JSON.stringify(data));
    ...
    function retrieveArticleFR() {
      $.get(ARTICLES_URL+"/article_fr.php", function( data ) {
          console.log('In handler !');
          if (data != null) {
            $('#article_fr').html(data);
            $('#article_fr img').each(function(){ this.src = ARTICLES_URL + '/' + this.src.substr(this.src.indexOf('images/')) });
          }
      })
      .fail(function(data) {
        console.log('In fail ! - ' + JSON.stringify(data));
